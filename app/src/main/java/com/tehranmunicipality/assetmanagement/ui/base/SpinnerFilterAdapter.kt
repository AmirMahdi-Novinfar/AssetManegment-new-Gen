...
class SpinnerFilterAdapter(context: Context, list : Array<String>)
   ...
   var list2 : Array<String> = list
    ...
    public fun spinnerfilteradapter(context: Context, list : Array<String>){
    ...
    {
        val view: View = layoutInflater.inflate(R.layout.spinner_layout_filter, null, true)
    ...
    override fun getDropDownView(position: Int, convertView: View?, parent: ViewGroup): View
    {
        var cv = convertView
        if(cv == null) {
            cv = layoutInflater.inflate(R.layout.spinner_layout_filter, parent, false)
