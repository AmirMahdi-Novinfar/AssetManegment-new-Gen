...
public class CaptureManager {
    ...
    public static boolean openFlashWhenStarted = false;
    ...
    public void initializeFromIntent(Intent intent, Bundle savedInstanceState) {
        ...
        if (intent != null) {
            ...
            if (intent.hasExtra(Intents.Scan.SERIAL_NUMBER)){
    ...
    public static Intent resultIntent(String barcodeSerial) {
        Intent intent = new Intent(Intents.Scan.ACTION);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_WHEN_TASK_RESET);
        intent.putExtra(Intents.Scan.RESULT, barcodeSerial);
        return intent;
    }
    ...
    protected void returnResult(BarcodeResult rawResult) {
        ...
        Log.i("DEBUG", "rawResult: " + rawResult.getText().toString());
        closeAndFinish();
    }

    protected void returnResult(String barcodeSerial) {
        Intent intent = resultIntent(barcodeSerial);
        activity.setResult(Activity.RESULT_OK, intent);
        Log.i("DEBUG", "barcodeSerial: " + barcodeSerial);
        closeAndFinish();
    }
